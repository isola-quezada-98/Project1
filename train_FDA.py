...
import pandas as pd
import numpy as np
from utils import poly_lr_scheduler, adjust_learning_rate_D, FDA_source_to_target
...
def train(args, model, optimizer, dataloader_train, dataloader_val, dataloader_target):
    ...
    for epoch in range(args.num_epochs):
        ...
        for i, (data_src, label) in enumerate(dataloader_train): #dataloader_train should be SOURCE DOMAIN
            ...
            data_src=FDA_source_to_target( data_src, data_targ, L=beta) 
            label = label.long().cuda()
...
def main(params):
    ...
    # train
    train(args, model,  optimizer, dataloader_train, dataloader_val, dataloader_target)
...
if __name__ == '__main__':
    params = [
        ...
        #'--pretrained_model_path','./checkpoints_FDA/latest_dice_loss.pth'
